...
class MainActivity2 : AppCompatActivity(), ItemListener {
    ...
    private fun fill(){
        ...
        val peticion = object: JsonObjectRequest(Request.Method.GET, url, null, {
            ...
            rvList.adapter = MyAdapter(lista, this)
                                                                     ...
                                                                     //Se cambio el short por un Long
    ...
    override fun onclick(v: View?, position: Int) {//cambio aqui
        Toast.makeText(this, "Click en $position,id:${lista[position][0]}", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onEdit(v: View, position: Int) {
        ...
        startActivity(i)//otro cambio aqui
    }
